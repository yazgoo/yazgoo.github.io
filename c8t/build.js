...
if (dx == null) dx = nil;
    ...
    return (def.$run_instruction = function(i) {
      ...
      ($a = ($b = (15)).$times, $a._p = (TMP_10 = function(i){var self = TMP_10._s || this;
        if (self.v == null) self.v = nil;
if (i == null) i = nil;
      return self.v['$[]='](i, self.v['$[]'](i)['$%'](256))}, TMP_10._s = self, TMP_10), $a).call($b);
...
if (y == null) y = nil;
      ...
      ($a = f00, $d = self.v, $d['$[]=']($a, $d['$[]']($a)['$+'](2)));}else if ((14)['$===']($case)) {self.v['$[]='](15, ((self.v['$[]'](f00)['$&'](57344))['$>>'](15)));
      ($a = f00, $d = self.v, $d['$[]=']($a, $d['$[]']($a)['$+'](2)));}}else if ((1)['$===']($case) || (2)['$===']($case)) {if (($a = (f000['$=='](2))) !== false && $a !== nil) {
...
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;
  $opal.add_stubs(['$output', '$parse', '$new', '$run_multiple', '$unparse', '$join', '$map', '$sprintf', '$to_i', '$scan', '$split', '$send!', '$errback', '$puts', '$callback']);
  ;
  ;
  ;
  ;
  return (function($base, $super) {
    ...
    return (def.$minify = function(address) {
      ...
      opts = $hash2(["payload"], {"payload": "url=http://github.com/&code=json"});
      return ($a = ($b = ($c = ($d = (($e = $scope.HTTP) == null ? $opal.cm('HTTP') : $e).$new("http://git.io", "POST", opts)).$callback, $c._p = (TMP_4 = function(a, b, c){var self = TMP_4._s || this;if (a == null) a = nil;if (b == null) b = nil;if (c == null) c = nil;
      return self.$puts("callback")}, TMP_4._s = self, TMP_4), $c).call($d)).$errback, $a._p = (TMP_3 = function(a, b, c){var self = TMP_3._s || this;if (a == null) a = nil;if (b == null) b = nil;if (c == null) c = nil;
      self.$puts("errback 0");
