...
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;
  $opal.add_stubs(['$output', '$parse', '$new', '$run_multiple', '$unparse', '$join', '$map', '$sprintf', '$to_i', '$scan', '$split', '$each', '$gsub', '$ord', '$reverse', '$decode', '$parameter', '$[]', '$+', '$encode', '$val', '$minify', '$p', '$value', '$value=', '$send!', '$errback', '$callback']);
  ;
  ;
  ;
  ;
  return (function($base, $super) {
    ...
    def.$minify_program = function() {
      ...
      address = address['$+']("?p="['$+'](self.$encode((($a = $scope.Element) == null ? $opal.cm('Element') : $a)['$[]']("#editor").$val())));
    ...
    def.$load_program = function() {
      ...
      pa = self.$parameter();
      self.$p(pa);
      self.$p((($a = $scope.Element) == null ? $opal.cm('Element') : $a)['$[]']("#editor").$value(self.$p()));
      if (pa !== false && pa !== nil) {
        return (($a = $scope.Element) == null ? $opal.cm('Element') : $a)['$[]']("#editor")['$value='](pa)
        } else {
        return nil
      };
    };
