...
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;
  $opal.add_stubs(['$output', '$parse', '$new', '$run_multiple', '$unparse', '$join', '$map', '$sprintf', '$to_i', '$scan', '$split', '$each', '$gsub', '$ord', '$reverse', '$decode', '$parameter', '$[]', '$+', '$encode', '$to_json', '$value', '$minify', '$value=', '$send!', '$errback', '$p', '$callback', '$puts', '$body']);
  ;
  ;
  ;
  ;
  return (function($base, $super) {
    ...
    return (def.$list = function() {
      var $a, $b, TMP_7, $c, self = this, opts = nil;
      opts = $hash2(["format", "payload"], {"format": "json", "payload": "apiKey=R_f857b8e18d6f401f917086b316e9f3de&login=c8tc8t"});
      return ($a = ($b = (($c = $scope.HTTP) == null ? $opal.cm('HTTP') : $c)).$new, $a._p = (TMP_7 = function(response){var self = TMP_7._s || this;if (response == null) response = nil;
      return self.$puts(response.$body())}, TMP_7._s = self, TMP_7), $a).call($b, "https://api.bitly.com/v3/user/link_history", "GET", opts)['$send!']();
    }, nil);
  })(self, null);
})(Opal);
