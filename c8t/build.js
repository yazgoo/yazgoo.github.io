...
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;
  $opal.add_stubs(['$output', '$parse', '$new', '$run_multiple', '$unparse', '$join', '$map', '$sprintf', '$to_i', '$scan', '$split', '$each', '$gsub', '$+', '$to_s', '$ord', '$send!', '$errback', '$p', '$callback']);
  ;
  ;
  ;
  ;
  return (function($base, $super) {
    ...
    return (def.$minify = function(address) {
      var $a, $b, TMP_3, $c, TMP_4, $d, $e, TMP_5, $f, self = this, opts = nil;
      ($a = ($b = [" ", ",", "/", "?", "=", "\n", "\r", ":"]).$each, $a._p = (TMP_3 = function(s){var self = TMP_3._s || this;if (s == null) s = nil;
      return address = address.$gsub(s, ("%"['$+'](s.$ord().$to_s(16))))}, TMP_3._s = self, TMP_3), $a).call($b);
      opts = $hash2(["format", "payload"], {"format": "json", "payload": "apiKey=R_f857b8e18d6f401f917086b316e9f3de&login=c8tc8t&longUrl="['$+'](address)});
      return ($a = ($c = ($d = ($e = (($f = $scope.HTTP) == null ? $opal.cm('HTTP') : $f).$new("http://api.bitly.com/v3/shorten?callback=?", "POST", opts)).$callback, $d._p = (TMP_5 = function(response){var self = TMP_5._s || this, url = nil;if (response == null) response = nil;
      url = response.body.data.url;
        return alert("url: " + url);}, TMP_5._s = self, TMP_5), $d).call($e)).$errback, $a._p = (TMP_4 = function(a, b, c){var self = TMP_4._s || this;if (a == null) a = nil;if (b == null) b = nil;if (c == null) c = nil;
      return self.$p(a, b, c)}, TMP_4._s = self, TMP_4), $a).call($c)['$send!']();
    }, nil);
  })(self, null);
})(Opal);
