...
(function($opal) {
  ...
  $opal.add_stubs(['$print', '$+', '$[]', '$*', '$==', '$read_nonblock', '$to_i', '$getc', '$include', '$size', '$/', '$new', '$map', '$zip', '$update', '$draw_box_s', '$every', '$-', '$<', '$clear', '$now', '$attr_accessor', '$each', '$is_a?', '$index', '$key', '$eq', '$eq=', '$block', '$nil?', '$sleep', '$unqueue', '$on_unblock', '$call', '$const_get', '$collect', '$to_proc', '$chars', '$concat', '$pause=', '$iterations=', '$log=', '$sound=', '$times', '$ready', '$pause', '$step', '$run', '$step=', '$run_multiple', '$run_instruction', '$>', '$beep', '$>>', '$&', '$get_current_key', '$[]=', '$each_with_index', '$push', '$^', '$write', '$delete_at', '$%', '$log', '$sprintf', '$parse_instruction_simple', '$printf', '$join', '$pop', '$===', '$|', '$include?', '$rand', '$draw', '$key_pressed', '$split']);
  (function($base, $super) {
    function $Terminal(){};
...
if (a == null) a = nil;
    ...
    def.$unqueue = function(a) {
      ...
      ($a = ($b = (($c = a, ((($d = $c.$eq()) !== false && $d !== nil) ? $d : $c['$eq=']((($e = $scope.EventQueue) == null ? $opal.cm('EventQueue') : $e).$new()))))).$each, $a._p = (TMP_5 = function(e){var self = TMP_5._s || this, $a, $b;if (e == null) e = nil;
...
(function($opal) {
  ...
  $opal.add_stubs(['$call', '$output', '$parse', '$new', '$run_multiple', '$<<', '$unparse', '$join', '$map', '$sprintf', '$to_i', '$scan', '$split', '$each', '$gsub', '$ord', '$reverse', '$decode', '$parameter', '$[]', '$+', '$encode', '$to_json', '$value', '$minify', '$value=', '$load_program', '$on', '$keys_push', '$key_code', '$/', '$-', '$page_x', '$width', '$target', '$every', '$>', '$focus', '$clear', '$send!', '$errback', '$p', '$callback', '$append', '$list', '$html', '$times', '$to_s', '$*', '$toggle', '$to_f', '$css', '$parent', '$==', '$check_uncheck']);
  ;
  ;
  ;
  ;
  ...
  return (function($base, $super) {
    ...
    def.$setup = function() {
      ...
      ($a = ($b = (($c = $scope.Element) == null ? $opal.cm('Element') : $c)['$[]']("body")).$on, $a._p = (TMP_7 = function(e){var self = TMP_7._s || this;if (e == null) e = nil;
      return self.$keys_push(key_to_keypad_key['$[]'](e.$key_code()))}, TMP_7._s = self, TMP_7), $a).call($b, "keydown");
      ($a = ($c = (($d = $scope.Element) == null ? $opal.cm('Element') : $d)['$[]']("#screen")).$on, $a._p = (TMP_8 = function(e){var self = TMP_8._s || this, $a, $b, TMP_9, left = nil, x = nil;if (e == null) e = nil;
...
if (e == null) e = nil;
    ...
    def.$goFullScreen = function() {
      ...
      canvas = (($a = $scope.Element) == null ? $opal.cm('Element') : $a)['$[]']("#screen");
    ...
    return (def.$play_pause = function() {
      var $a, self = this;
