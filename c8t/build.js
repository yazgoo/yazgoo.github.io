...
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;
  $opal.add_stubs(['$output', '$parse', '$new', '$run_multiple', '$unparse', '$join', '$map', '$sprintf', '$to_i', '$scan', '$split', '$+', '$send!', '$errback', '$p', '$puts', '$callback']);
  ;
  ;
  ;
  ;
  return (function($base, $super) {
    ...
    return (def.$minify = function(address) {
      var $a, $b, TMP_3, $c, $d, TMP_4, $e, self = this, opts = nil;
      opts = $hash2(["format", "payload"], {"format": "json", "payload": "apiKey=R_f857b8e18d6f401f917086b316e9f3de&login=c8tc8t&longUrl="['$+'](address)});
      return ($a = ($b = ($c = ($d = (($e = $scope.HTTP) == null ? $opal.cm('HTTP') : $e).$new("http://api.bitly.com/v3/shorten?callback=?", "POST", opts)).$callback, $c._p = (TMP_4 = function(response){var self = TMP_4._s || this, url = nil;if (response == null) response = nil;
      url = response.body.data.url;
        return alert("url: " + url);}, TMP_4._s = self, TMP_4), $c).call($d)).$errback, $a._p = (TMP_3 = function(a, b, c){var self = TMP_3._s || this;if (a == null) a = nil;if (b == null) b = nil;if (c == null) c = nil;
      self.$p(a, b, c);
        self.$puts("errback 0");
        return self.$puts("errback 4");}, TMP_3._s = self, TMP_3), $a).call($b)['$send!']();
    }, nil);
  })(self, null);
})(Opal);
