...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_accessor', '$[]', '$to_i', '$-', '$new']);
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      return (def.$each = TMP_1 = function() {
        var $a, self = this, $iter = TMP_1._p, $yield = $iter || nil, t = nil, i = nil;
        TMP_1._p = null;
...
if (dx == null) dx = nil;
        xy = [(self.v['$[]'](f00)['$+'](dx))['$%'](self.width), (self.v['$[]'](f0)['$+'](dy))['$%'](self.height)];
...
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;
  $opal.add_stubs(['$output', '$parse', '$new', '$run_multiple', '$unparse', '$join', '$map', '$sprintf', '$to_i', '$scan', '$split', '$each', '$gsub', '$ord', '$reverse', '$decode', '$parameter', '$[]', '$+', '$encode', '$to_json', '$value', '$minify', '$value=', '$send!', '$errback', '$p', '$callback', '$append']);
  ;
  ;
  ;
  ;
  return (function($base, $super) {
    ...
    def.$run2 = function(text) {
      var $a, $b, TMP_2, self = this, assembly = nil, e = nil;
      assembly = ($a = ($b = text.$split("\n").$join().$scan(/../)).$map, $a._p = (TMP_2 = function(s){var self = TMP_2._s || this;if (s == null) s = nil;
      return s.$to_i(16)}, TMP_2._s = self, TMP_2), $a).call($b);
      e = (($a = $scope.Emulator) == null ? $opal.cm('Emulator') : $a).$new(assembly, "Window");
      e.$run_multiple();
      return e;
    };
    ...
    def.$minify = function(address) {
      var $a, $b, TMP_5, $c, $d, TMP_6, $e, self = this, opts = nil;
      ...
      return ($a = ($b = ($c = ($d = (($e = $scope.HTTP) == null ? $opal.cm('HTTP') : $e).$new("http://api.bitly.com/v3/shorten?callback=?", "POST", opts)).$callback, $c._p = (TMP_6 = function(response){var self = TMP_6._s || this, url = nil;if (response == null) response = nil;
      url = response.body.data.url;
        return alert("url: " + url);}, TMP_6._s = self, TMP_6), $c).call($d)).$errback, $a._p = (TMP_5 = function(a, b, c){var self = TMP_5._s || this;if (a == null) a = nil;if (b == null) b = nil;if (c == null) c = nil;
      return self.$p(a, b, c)}, TMP_5._s = self, TMP_5), $a).call($b)['$send!']();
    };

    def.$list = function() {
      var $a, self = this, opts = nil;
      opts = $hash2(["payload"], {"payload": "format=json&q="['$+'](self.$encode("select * from json where url=\"https://bitly.com/u/c8tc8t.json\""))});
    ...
    return (def.$parse_response = function(response) {
      var $a, $b, TMP_7, $c, self = this, data = nil;
      ...
      ($a = ($b = (($c = $scope.JSON) == null ? $opal.cm('JSON') : $c).$parse(data)).$each, $a._p = (TMP_7 = function(l){var self = TMP_7._s || this, $a, option_s = nil, option = nil;if (l == null) l = nil;
      option_s = l['$[]']("url").$split("?p=")['$[]'](1);
        option = (($a = $scope.JSON) == null ? $opal.cm('JSON') : $a).$parse(option_s);
        return (($a = $scope.Element) == null ? $opal.cm('Element') : $a)['$[]']("#choose").$append("<option value='" + (option_s) + "'>" + (option['$[]']("title")) + "</option>");}, TMP_7._s = self, TMP_7), $a).call($b);
      return (($a = $scope.Element) == null ? $opal.cm('Element') : $a)['$[]']("#choose").$append("<option>-------</option>");
    }, nil);
  })(self, null);
})(Opal);
