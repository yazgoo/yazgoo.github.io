...
(function($opal) {
  ...
  $opal.add_stubs(['$print', '$+', '$[]', '$*', '$==', '$read_nonblock', '$to_i', '$getc', '$include', '$/', '$new', '$map', '$zip', '$update', '$draw_box_s', '$attr_accessor', '$each', '$is_a?', '$index', '$key', '$eq', '$eq=', '$block', '$nil?', '$size', '$sleep', '$unqueue', '$on_unblock', '$call', '$const_get', '$collect', '$-', '$to_proc', '$chars', '$concat', '$ready', '$pause', '$step', '$times', '$run', '$step=', '$pause=', '$log=', '$run_multiple', '$run_instruction', '$>', '$now', '$beep', '$>>', '$&', '$get_current_key', '$[]=', '$each_with_index', '$%', '$push', '$^', '$log', '$puts', '$join', '$write', '$delete_at', '$sprintf', '$parse_instruction_simple', '$printf', '$pop', '$===', '$|', '$include?', '$rand', '$draw', '$key_pressed', '$split']);
  (function($base, $super) {
    function $Terminal(){};
...
if (a == null) a = nil;
  ...
  return (function($base, $super) {
    ...
    def.$initialize = function(str, ui) {
      ...
      return self.I = self.DT = self.ST = 0}, TMP_6._s = self, TMP_6), $a).call($c, 16);
      self.ready = true;
      self.pause = false;
      self.step = false;
      self.log = false;
    ...
    self.$attr_accessor("ready", "pause", "step", "log");
    ...
    def.$run_multiple = function(b) {
      ...
      if (($a = ($b = b.$ready(), $b !== false && $b !== nil ?(((($c = ($d = b.$pause(), ($d === nil || $d === false))) !== false && $c !== nil) ? $c : (($d = b.$pause(), $d !== false && $d !== nil ?b.$step() : $d)))) : $b)) !== false && $a !== nil) {
        ($a = ($b = self.iterations).$times, $a._p = (TMP_7 = function(){var self = TMP_7._s || this;
        return b.$run()}, TMP_7._s = self, TMP_7), $a).call($b)};
      b['$step='](false);
      if ((($a = $scope.ENV) == null ? $opal.cm('ENV') : $a).$size()['$=='](0)) {
...
if (dx == null) dx = nil;
        xy = [(self.v['$[]'](f00)['$+'](dx))['$%'](self.width), (self.v['$[]'](f0)['$+'](dy))['$%'](self.height)];
          ...
          if (($a = self.$log()) !== false && $a !== nil) {
            self.$puts("(" + (xy.$join(",")) + ") (" + (self.video['$[]'](xy).$join(",")) + ")")};
    ...
    return (def.$run_instruction = function(i) {
      var $a, $b, TMP_10, $c, $d, TMP_12, TMP_13, $e, TMP_14, $f, TMP_15, self = this, ins = nil, dis = nil, f000 = nil, f00 = nil, f0 = nil, f = nil, ff = nil, fff = nil, $case = nil, a = nil;
      if (($a = self.$log()) !== false && $a !== nil) {
        ((($a = self.assembler) !== false && $a !== nil) ? $a : self.assembler = (($b = $scope.Assembler) == null ? $opal.cm('Assembler') : $b).$new());
      ...
      if (i['$=='](0)) {
        return nil};
      if (i['$=='](224)) {
        ($a = ($b = self.width).$times, $a._p = (TMP_10 = function(x){var self = TMP_10._s || this, $a, $b, TMP_11;
          if (self.height == null) self.height = nil;
if (x == null) x = nil;
        return ($a = ($b = self.height).$times, $a._p = (TMP_11 = function(y){var self = TMP_11._s || this;
            if (self.out == null) self.out = nil;
if (y == null) y = nil;
          return self.out.$write([x, y], 0)}, TMP_11._s = self, TMP_11), $a).call($b)}, TMP_10._s = self, TMP_10), $a).call($b);
        self.video = $hash2([], {});};
      if (i['$=='](238)) {
      ...
      self.v['$[]='](15, ((function() {if (($a = ($c = a['$==']((self.v['$[]='](f00, (a['$%'](256))))), ($c === nil || $c === false))) !== false && $a !== nil) {
        return 1
        } else {
        return 0
      ...
      self.v['$[]='](f00, self.v['$[]'](f00)['$-'](self.v['$[]'](f0)));}else if ((6)['$===']($case)) {self.v['$[]='](15, (self.v['$[]'](f00)['$&'](1)))}else if ((14)['$===']($case)) {self.v['$[]='](15, ((self.v['$[]'](f00)['$&'](57344))['$>>'](15)))}}else if ((1)['$===']($case) || (2)['$===']($case)) {if (($a = (f000['$=='](2))) !== false && $a !== nil) {
      ...
      return false;}else if ((3)['$===']($case) || (5)['$===']($case)) {if (self.v['$[]'](f00)['$=='](((function() {if (($a = [3, 4]['$include?'](f000)) !== false && $a !== nil) {
        ...
        self.pc = self.pc['$+'](2)}}else if ((4)['$===']($case) || (9)['$===']($case)) {if (($a = ($c = self.v['$[]'](f00)['$=='](((function() {if (($d = [3, 4]['$include?'](f000)) !== false && $d !== nil) {
        return ff
        } else {
        return self.v['$[]'](f0)
      }; return nil; })())), ($c === nil || $c === false))) !== false && $a !== nil) {
        self.pc = self.pc['$+'](2)}}else if ((6)['$===']($case)) {self.v['$[]='](f00, ff)}else if ((7)['$===']($case)) {($a = f00, $c = self.v, $c['$[]=']($a, $c['$[]']($a)['$+'](ff)))}else if ((11)['$===']($case)) {self.pc = fff['$+'](self.v['$[]'](0));
      ...
      self['in'].$get_current_key(true, ($a = ($c = (($d = $scope.Proc) == null ? $opal.cm('Proc') : $d)).$new, $a._p = (TMP_12 = function(e){var self = TMP_12._s || this;
        if (self.v == null) self.v = nil;
if (e == null) e = nil;
      self.v['$[]='](f00, e);
        return self.ready = true;}, TMP_12._s = self, TMP_12), $a).call($c));}else if ((21)['$===']($case)) {self.ST = self.v['$[]'](f00)}else if ((24)['$===']($case)) {self.DT = self.v['$[]'](f00)}else if ((41)['$===']($case)) {self.I = self.v['$[]'](f00)['$*'](5)}else if ((7)['$===']($case)) {self.v['$[]='](f00, self.DT)}else if ((51)['$===']($case)) {($a = ($d = self.$sprintf("%03d", self.v['$[]'](f00)).$split("")).$each_with_index, $a._p = (TMP_13 = function(v, x){var self = TMP_13._s || this;
        if (self.mem == null) self.mem = nil;
        if (self.I == null) self.I = nil;
if (v == null) v = nil;if (x == null) x = nil;
      return self.mem['$[]='](self.I['$+'](x), v)}, TMP_13._s = self, TMP_13), $a).call($d)}else if ((85)['$===']($case)) {($a = ($e = (f00['$+'](1))).$times, $a._p = (TMP_14 = function(x){var self = TMP_14._s || this;
        if (self.mem == null) self.mem = nil;
        if (self.I == null) self.I = nil;
        if (self.v == null) self.v = nil;
if (x == null) x = nil;
      return self.mem['$[]='](x['$+'](self.I), self.v['$[]'](x))}, TMP_14._s = self, TMP_14), $a).call($e)}else if ((101)['$===']($case)) {($a = ($f = (f00['$+'](1))).$times, $a._p = (TMP_15 = function(x){var self = TMP_15._s || this;
        if (self.v == null) self.v = nil;
        if (self.mem == null) self.mem = nil;
        if (self.I == null) self.I = nil;
if (x == null) x = nil;
      return self.v['$[]='](x, self.mem['$[]'](x['$+'](self.I)).$to_i())}, TMP_15._s = self, TMP_15), $a).call($f)}};
      return true;
    }, nil);
  })(self, null);
})(Opal);
...
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
  $opal.add_stubs(['$output', '$parse', '$new', '$run_multiple', '$unparse', '$join', '$map', '$sprintf', '$to_i', '$scan', '$split']);
  ;
  ;
  ;
  return (function($base, $super) {
