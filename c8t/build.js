...
(function($opal) {
  ...
  $opal.add_stubs(['$collect', '$gsub', '$[]', '$to_proc', '$to_a', '$is_a?', '$each', '$parse_line', '$include?', '$split', '$parse_instruction', '$scan', '$join', '$upcase', '$match', '$new', '$to_s', '$start_with?', '$sprintf', '$map', '$to_i', '$keys', '$<<', '$parse_instruction_simple', '$assemble', '$collect!', '$=~', '$>', '$size', '$==', '$[]=', '$first', '$compact', '$nil?', '$last', '$+']);
  return (function($base, $super) {
    function $Assembler(){};
    var self = $Assembler = $klass($base, $super, 'Assembler', $Assembler);

    var def = $Assembler._proto, $scope = $Assembler._scope;
    def.instructions = def.reverse_instructions = def.text = def.binary = def.result = def.labels = def.address = nil;
...
if (re == null) re = nil;
    ...
    def.$parse_instruction = function(i) {
      var self = this;
      return self.text['$<<'](self.$parse_instruction_simple(i));
    };
...
if (p == null) p = nil;
    ...
    return (def.$parse_line = function(line) {
      var $a, $b, TMP_10, $c, TMP_11, self = this, r = nil;
      line = line.$split(" ");
      if (line.$size()['$>'](0)) {
        if (line['$[]'](0)['$[]'](0)['$=='](";")) {
          return nil};
...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_accessor', '$[]', '$to_i', '$-', '$shift', '$nil?', '$new']);
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      var def = $EventQueue._proto, $scope = $EventQueue._scope, TMP_1;
      return (def.$each = TMP_1 = function() {
        var $a, $b, $c, self = this, $iter = TMP_1._p, $yield = $iter || nil, array = nil, k = nil, t = nil, i = nil;
        TMP_1._p = null;
        array = window.key;
        k = nil;
        while (($b = true) !== false && $b !== nil) {
        k = array.$shift();
        if (($b = ((($c = k == undefined) !== false && $c !== nil) ? $c : k['$nil?']())) !== false && $b !== nil) {
          break;};
        t = [42, 34, 171, 187, 40, 41, 64, 43, 45, 47, 97, 98, 99, 100, 101, 102];
        i = t['$[]'](k);
        if ($opal.$yield1($yield, (($b = $scope.KeyDownEvent) == null ? $opal.cm('KeyDownEvent') : $b).$new(i)) === $breaker) return $breaker.$v;};
      }, nil)
    })(self, null);
...
(function($opal) {
  ...
  $opal.add_stubs(['$print', '$+', '$[]', '$*', '$==', '$read_nonblock', '$to_i', '$getc', '$include', '$size', '$/', '$new', '$map', '$zip', '$update', '$draw_box_s', '$attr_accessor', '$each', '$is_a?', '$index', '$key', '$eq', '$eq=', '$block', '$nil?', '$sleep', '$unqueue', '$on_unblock', '$call', '$const_get', '$collect', '$-', '$to_proc', '$chars', '$concat', '$pause=', '$iterations=', '$log=', '$times', '$ready', '$pause', '$step', '$run', '$step=', '$run_multiple', '$run_instruction', '$>', '$now', '$beep', '$>>', '$&', '$get_current_key', '$[]=', '$each_with_index', '$<', '$push', '$^', '$write', '$log', '$p', '$delete_at', '$%', '$sprintf', '$parse_instruction_simple', '$printf', '$join', '$pop', '$===', '$|', '$include?', '$rand', '$draw', '$key_pressed', '$split']);
  (function($base, $super) {
    function $Terminal(){};
...
if (a == null) a = nil;
    ...
    def.$unqueue = function(a) {
      var $a, $b, TMP_4, $c, $d, $e, self = this, i = nil, keys = nil;
      if (a == null) {
        a = self
      }
      i = nil;
      keys = [42, 34, 171, 187, 40, 41, 64, 43, 45, 47, 97, 98, 99, 100, 101, 102];
      ($a = ($b = (($c = a, ((($d = $c.$eq()) !== false && $d !== nil) ? $d : $c['$eq=']((($e = $scope.EventQueue) == null ? $opal.cm('EventQueue') : $e).$new()))))).$each, $a._p = (TMP_4 = function(e){var self = TMP_4._s || this, $a, $b;if (e == null) e = nil;
      if (($a = e['$is_a?']((($b = $scope.KeyDownEvent) == null ? $opal.cm('KeyDownEvent') : $b))) !== false && $a !== nil) {
  ...
  return (function($base, $super) {
    ...
    def.width = def.height = def.mem = def.iterations = def.pc = def.t = def.DT = def.ST = def.out = def.i = def.v = def['in'] = def.I = def.assembler = def.stack = nil;
    def.$initialize = function(str, ui) {
      var $a, $b, TMP_5, $c, $d, TMP_6, $e, self = this;
      self.width = 64;
      self.height = 32;
      self.video = self['in'] = self.out = (($a = $scope.Object) == null ? $opal.cm('Object') : $a).$const_get(ui).$new(self.width, self.height);
      self.mem = ($a = ($b = ($c = ($d = ("PJJJPCGCCHPBPIPPBPBPJJPBBPIPBPPIPJPPBCEEPJPJPPJPBPPJPJJOJOJOPIIIPOJJJOPIPIPPIPII").$chars()).$map, $c._p = "ord".$to_proc(), $c).call($d)).$collect, $a._p = (TMP_5 = function(x){var self = TMP_5._s || this;if (x == null) x = nil;
      return (x['$-'](65))['$*'](16)}, TMP_5._s = self, TMP_5), $a).call($b);
      self.mem = self.mem.$concat([0]['$*'](((self.pc = 512)['$-'](80)))).$concat(str);
      self.mem = self.mem.$concat([0]['$*'](1000));
      self.stack = self.v = ($a = ($c = (($e = $scope.Array) == null ? $opal.cm('Array') : $e)).$new, $a._p = (TMP_6 = function(){var self = TMP_6._s || this;
      return 0}, TMP_6._s = self, TMP_6), $a).call($c, 16);
    ...
    self.$attr_accessor("ready", "pause", "step", "log", "iterations");
    ...
    def.$run_multiple = function(b) {
      ...
      ($a = ($b = self.iterations).$times, $a._p = (TMP_7 = function(){var self = TMP_7._s || this, $a, $b, $c, $d;
    ...
    def.$draw = function() {
      var $a, $b, TMP_8, self = this, f = nil, f00 = nil, f0 = nil;
      self.v['$[]='](15, 0);
      f = self.i['$&'](15);
      f00 = (self.i['$&'](3840))['$>>'](8);
      f0 = (self.i['$&'](240))['$>>'](4);
      return ($a = ($b = self.mem['$[]']($range(self.I, (self.I['$+'](f)['$-'](1)), false))).$each_with_index, $a._p = (TMP_8 = function(line, dy){var self = TMP_8._s || this, $a, $b, TMP_9;if (line == null) line = nil;if (dy == null) dy = nil;
      return ($a = ($b = (8)).$times, $a._p = (TMP_9 = function(dx){var self = TMP_9._s || this, $a, $b, $c, xy = nil;
...
if (dx == null) dx = nil;
    ...
    return (def.$run_instruction = function(i) {
      var $a, $b, TMP_10, $c, TMP_11, $d, $e, TMP_13, TMP_14, $f, TMP_15, $g, TMP_16, self = this, ins = nil, dis = nil, f000 = nil, f00 = nil, f0 = nil, f = nil, ff = nil, fff = nil, $case = nil, a = nil;
      ($a = ($b = (16)).$times, $a._p = (TMP_10 = function(k){var self = TMP_10._s || this;
        if (self.v == null) self.v = nil;
if (k == null) k = nil;
      return self.v['$[]='](k, self.v['$[]'](k)['$%'](256))}, TMP_10._s = self, TMP_10), $a).call($b);
      if (($a = self.$log()) !== false && $a !== nil) {
      ...
      if (i['$=='](0)) {
        return nil};
      if (i['$=='](224)) {
        ($a = ($c = self.width).$times, $a._p = (TMP_11 = function(x){var self = TMP_11._s || this, $a, $b, TMP_12;
          if (self.height == null) self.height = nil;
if (x == null) x = nil;
        return ($a = ($b = self.height).$times, $a._p = (TMP_12 = function(y){var self = TMP_12._s || this;
            if (self.out == null) self.out = nil;
if (y == null) y = nil;
          return self.out.$write([x, y], 0)}, TMP_12._s = self, TMP_12), $a).call($b)}, TMP_11._s = self, TMP_11), $a).call($c);
        self.video = $hash2([], {});};
      if (i['$=='](238)) {
      ...
      self['in'].$get_current_key(true, ($a = ($d = (($e = $scope.Proc) == null ? $opal.cm('Proc') : $e)).$new, $a._p = (TMP_13 = function(e){var self = TMP_13._s || this;
        if (self.v == null) self.v = nil;
if (e == null) e = nil;
      self.v['$[]='](f00, e);
        return self.ready = true;}, TMP_13._s = self, TMP_13), $a).call($d));}else if ((21)['$===']($case)) {self.ST = self.v['$[]'](f00)}else if ((24)['$===']($case)) {self.DT = self.v['$[]'](f00)}else if ((41)['$===']($case)) {self.I = self.v['$[]'](f00)['$*'](5)}else if ((7)['$===']($case)) {self.v['$[]='](f00, self.DT)}else if ((51)['$===']($case)) {($a = ($e = self.$sprintf("%03d", self.v['$[]'](f00)).$split("")).$each_with_index, $a._p = (TMP_14 = function(v, x){var self = TMP_14._s || this;
        if (self.mem == null) self.mem = nil;
        if (self.I == null) self.I = nil;
if (v == null) v = nil;if (x == null) x = nil;
      return self.mem['$[]='](self.I['$+'](x), v)}, TMP_14._s = self, TMP_14), $a).call($e)}else if ((85)['$===']($case)) {($a = ($f = (f00['$+'](1))).$times, $a._p = (TMP_15 = function(x){var self = TMP_15._s || this;
        if (self.mem == null) self.mem = nil;
        if (self.I == null) self.I = nil;
        if (self.v == null) self.v = nil;
if (x == null) x = nil;
      return self.mem['$[]='](x['$+'](self.I), self.v['$[]'](x))}, TMP_15._s = self, TMP_15), $a).call($f)}else if ((101)['$===']($case)) {($a = ($g = (f00['$+'](1))).$times, $a._p = (TMP_16 = function(x){var self = TMP_16._s || this;
        if (self.v == null) self.v = nil;
        if (self.mem == null) self.mem = nil;
        if (self.I == null) self.I = nil;
if (x == null) x = nil;
      return self.v['$[]='](x, self.mem['$[]'](x['$+'](self.I)).$to_i())}, TMP_16._s = self, TMP_16), $a).call($g)}};
      return true;
    }, nil);
  })(self, null);
})(Opal);
...
(function($opal) {
  ...
  $opal.add_stubs(['$call', '$output', '$parse', '$new', '$run_multiple', '$<<', '$unparse', '$join', '$map', '$sprintf', '$to_i', '$scan', '$split', '$each', '$gsub', '$ord', '$reverse', '$decode', '$parameter', '$[]', '$+', '$encode', '$to_json', '$value', '$minify', '$value=', '$load_program', '$on', '$keys_push', '$key_code', '$/', '$-', '$page_x', '$width', '$target', '$every', '$>', '$clear', '$send!', '$errback', '$p', '$callback', '$==', '$append', '$list']);
  ;
  ;
  ;
  ;
  ...
  return (function($base, $super) {
    ...
    def.$run = function(text) {
      var $a, self = this, assembly = nil, e = nil;
    ...
    def.$keys_push = function(k) {
      var $a, self = this;
      return (($a = $opal.cvars['@@keys']) == null ? nil : $a)['$<<'](k);
    };
    ...
    def.$assemble = function(text) {
      ...
      return ($a = ($b = (($c = $scope.Assembler) == null ? $opal.cm('Assembler') : $c).$new().$parse(text).$output()).$map, $a._p = (TMP_2 = function(x){var self = TMP_2._s || this;if (x == null) x = nil;
      return self.$sprintf("%02X", x)}, TMP_2._s = self, TMP_2), $a).call($b).$join();
    };

    def.$run2 = function(text) {
      var $a, $b, TMP_3, self = this, assembly = nil, e = nil;
      assembly = ($a = ($b = text.$split("\n").$join().$scan(/../)).$map, $a._p = (TMP_3 = function(s){var self = TMP_3._s || this;if (s == null) s = nil;
      return s.$to_i(16)}, TMP_3._s = self, TMP_3), $a).call($b);
      e = (($a = $scope.Emulator) == null ? $opal.cm('Emulator') : $a).$new(assembly, "Window");
      e.$run_multiple();
      return e;
    };
    ...
    def.$encode = function(address) {
      ...
      return address = address.$gsub(s, (self.$sprintf("%%%02X", s.$ord())))}, TMP_4._s = self, TMP_4), $a).call($b);
      return address;
    };

    def.$decode = function(address) {
      var $a, $b, TMP_5, self = this;
      ($a = ($b = self.special.$reverse()).$each, $a._p = (TMP_5 = function(s){var self = TMP_5._s || this;if (s == null) s = nil;
      return address = address.$gsub(self.$sprintf("%%%02X", s.$ord()), s)}, TMP_5._s = self, TMP_5), $a).call($b);
      return address;
    };
    ...
    def.$setup = function() {
      var $a, $b, TMP_6, $c, TMP_7, $d, TMP_9, $e, self = this, key_to_keypad_key = nil;
      ($opal.cvars['@@keys'] = []);
       window.key = (($a = $opal.cvars['@@keys']) == null ? nil : $a);
      self.$load_program();
      key_to_keypad_key = $hash(37, 4, 39, 6, 38, 2, 40, 8, 32, 5);
      ($a = ($b = (($c = $scope.Element) == null ? $opal.cm('Element') : $c)['$[]']("body")).$on, $a._p = (TMP_6 = function(e){var self = TMP_6._s || this;if (e == null) e = nil;
      return self.$keys_push()['$<<'](key_to_keypad_key['$[]'](e.$key_code()))}, TMP_6._s = self, TMP_6), $a).call($b, "keydown");
      ($a = ($c = (($d = $scope.Element) == null ? $opal.cm('Element') : $d)['$[]']("#screen")).$on, $a._p = (TMP_7 = function(e){var self = TMP_7._s || this, $a, $b, TMP_8, left = nil, x = nil;if (e == null) e = nil;
      left = e.$target().offset().left;
        x = (e.$page_x()['$-'](left))['$/'](e.$target().$width());
        return self.click = ($a = ($b = self).$every, $a._p = (TMP_8 = function(){var self = TMP_8._s || this, k = nil;
        k = (function() {if (x['$>']((2.0)['$/'](3))) {
            return 6
          } else if (x['$>']((1.0)['$/'](3))) {
            return 5
            } else {
          ...
          return self.$keys_push(k);}, TMP_8._s = self, TMP_8), $a).call($b, 100);}, TMP_7._s = self, TMP_7), $a).call($c, "mousedown");
      return ($a = ($d = (($e = $scope.Element) == null ? $opal.cm('Element') : $e)['$[]']("#screen")).$on, $a._p = (TMP_9 = function(e){var self = TMP_9._s || this;
        if (self.click == null) self.click = nil;
if (e == null) e = nil;
      return self.$clear(self.click)}, TMP_9._s = self, TMP_9), $a).call($d, "mouseup");
    };

    def.$minify = function(address) {
      var $a, $b, TMP_10, $c, $d, TMP_11, $e, self = this, opts = nil;
      ...
      return ($a = ($b = ($c = ($d = (($e = $scope.HTTP) == null ? $opal.cm('HTTP') : $e).$new("http://api.bitly.com/v3/shorten?callback=?", "POST", opts)).$callback, $c._p = (TMP_11 = function(response){var self = TMP_11._s || this, url = nil;if (response == null) response = nil;
      url = response.body.data.url;
        return alert("url: " + url);}, TMP_11._s = self, TMP_11), $c).call($d)).$errback, $a._p = (TMP_10 = function(a, b, c){var self = TMP_10._s || this;if (a == null) a = nil;if (b == null) b = nil;if (c == null) c = nil;
      return self.$p(a, b, c)}, TMP_10._s = self, TMP_10), $a).call($b)['$send!']();
    };
    ...
    def.$list = function(page) {
      ...
      if (page['$=='](1)) {
        (($a = $scope.Element) == null ? $opal.cm('Element') : $a)['$[]']("#choose").$append("<option>----dyn---</option>")};
      opts = $hash2(["payload"], {"payload": "format=json&q="['$+'](self.$encode("select * from json where url=\"https://bitly.com/u/c8tc8t.json?page=" + (page) + "\""))});
      return (($a = $scope.HTTP) == null ? $opal.cm('HTTP') : $a).$new("http://query.yahooapis.com/v1/public/yql?callback=parse_response", "POST", opts)['$send!']();
    };

    return (def.$parse_response = function(response) {
      var $a, $b, TMP_12, $c, self = this, data = nil;
      if (($a = response.query.results.json.data != undefined) !== false && $a !== nil) {
        data = JSON.stringify(response.query.results.json.data);
        ($a = ($b = (($c = $scope.JSON) == null ? $opal.cm('JSON') : $c).$parse(data)).$each, $a._p = (TMP_12 = function(l){var self = TMP_12._s || this, $a, option_s = nil, option = nil;if (l == null) l = nil;
        option_s = l['$[]']("url").$split("?p=")['$[]'](1);
          option = (($a = $scope.JSON) == null ? $opal.cm('JSON') : $a).$parse(option_s);
          return (($a = $scope.Element) == null ? $opal.cm('Element') : $a)['$[]']("#choose").$append("<option value='" + (option_s) + "'>" + (option['$[]']("title")) + "</option>");}, TMP_12._s = self, TMP_12), $a).call($b);
