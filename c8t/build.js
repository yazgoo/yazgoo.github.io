...
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;
  $opal.add_stubs(['$output', '$parse', '$new', '$run_multiple', '$unparse', '$join', '$map', '$sprintf', '$to_i', '$scan', '$split', '$each', '$gsub', '$ord', '$reverse', '$decode', '$parameter', '$[]', '$+', '$encode', '$to_json', '$value', '$minify', '$value=', '$send!', '$errback', '$p', '$callback', '$get', '$puts', '$body']);
  ;
  ;
  ;
  ;
  return (function($base, $super) {
    ...
    return (def.$list = function() {
      ...
      return ($a = ($b = (($c = $scope.HTTP) == null ? $opal.cm('HTTP') : $c)).$get, $a._p = (TMP_7 = function(response){var self = TMP_7._s || this;if (response == null) response = nil;
      return self.$puts(response.$body())}, TMP_7._s = self, TMP_7), $a).call($b, "http://bitly.com/u/c8tc8t.json");
    }, nil);
  })(self, null);
})(Opal);
