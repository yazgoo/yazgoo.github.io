...
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;
  $opal.add_stubs(['$output', '$parse', '$new', '$run_multiple', '$unparse', '$join', '$map', '$sprintf', '$to_i', '$scan', '$split', '$each', '$gsub', '$ord', '$reverse', '$decode', '$parameter', '$[]', '$+', '$encode', '$value', '$minify', '$value=', '$send!', '$errback', '$p', '$callback']);
  ;
  ;
  ;
  ;
  return (function($base, $super) {
    ...
    def.$minify_program = function() {
      ...
      address = address['$+']("?p="['$+'](self.$encode((($a = $scope.Element) == null ? $opal.cm('Element') : $a)['$[]']("#editor").$value())));
    ...
    def.$load_program = function() {
      var $a, self = this;
      if (($a = self.$parameter()) !== false && $a !== nil) {
        return (($a = $scope.Element) == null ? $opal.cm('Element') : $a)['$[]']("#editor")['$value='](self.$parameter())
        } else {
        return nil
      };
    };
