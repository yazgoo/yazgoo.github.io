...
if (a == null) a = nil;
  ...
  return (function($base, $super) {
    ...
    def.width = def.height = def.mem = def.pc = def.t = def.DT = def.ST = def.out = def.i = def.v = def['in'] = def.I = def.assembler = def.stack = nil;
    ...
    def.$draw = function() {
      var $a, $b, TMP_7, self = this, f = nil, f00 = nil, f0 = nil;
      self.v['$[]='](15, 0);
      f = self.i['$&'](15);
      f00 = (self.i['$&'](3840))['$>>'](8);
      f0 = (self.i['$&'](240))['$>>'](4);
      return ($a = ($b = self.mem['$[]']($range(self.I, (self.I['$+'](f)['$-'](1)), false))).$each_with_index, $a._p = (TMP_7 = function(line, dy){var self = TMP_7._s || this, $a, $b, TMP_8;if (line == null) line = nil;if (dy == null) dy = nil;
      return ($a = ($b = (8)).$times, $a._p = (TMP_8 = function(dx){var self = TMP_8._s || this, $a, $b, $c, xy = nil;
...
if (dx == null) dx = nil;
    ...
    return (def.$run_instruction = function(i) {
      var $a, $b, TMP_9, $c, $d, TMP_11, TMP_12, $e, TMP_13, $f, TMP_14, self = this, ins = nil, dis = nil, f000 = nil, f00 = nil, f0 = nil, f = nil, ff = nil, fff = nil, $case = nil, a = nil;
      if (($a = self.$log()) !== false && $a !== nil) {
      ...
      if (i['$=='](0)) {
        return nil};
      if (i['$=='](224)) {
        ($a = ($b = self.width).$times, $a._p = (TMP_9 = function(x){var self = TMP_9._s || this, $a, $b, TMP_10;
          if (self.height == null) self.height = nil;
if (x == null) x = nil;
        return ($a = ($b = self.height).$times, $a._p = (TMP_10 = function(y){var self = TMP_10._s || this;
            if (self.out == null) self.out = nil;
if (y == null) y = nil;
          return self.out.$write([x, y], 0)}, TMP_10._s = self, TMP_10), $a).call($b)}, TMP_9._s = self, TMP_9), $a).call($b);
        self.video = $hash2([], {});};
      if (i['$=='](238)) {
      ...
      self['in'].$get_current_key(true, ($a = ($c = (($d = $scope.Proc) == null ? $opal.cm('Proc') : $d)).$new, $a._p = (TMP_11 = function(e){var self = TMP_11._s || this;
        if (self.v == null) self.v = nil;
if (e == null) e = nil;
      self.v['$[]='](f00, e);
        return self.ready = true;}, TMP_11._s = self, TMP_11), $a).call($c));}else if ((21)['$===']($case)) {self.ST = self.v['$[]'](f00)}else if ((24)['$===']($case)) {self.DT = self.v['$[]'](f00)}else if ((41)['$===']($case)) {self.I = self.v['$[]'](f00)['$*'](5)}else if ((7)['$===']($case)) {self.v['$[]='](f00, self.DT)}else if ((51)['$===']($case)) {($a = ($d = self.$sprintf("%03d", self.v['$[]'](f00)).$split("")).$each_with_index, $a._p = (TMP_12 = function(v, x){var self = TMP_12._s || this;
        if (self.mem == null) self.mem = nil;
        if (self.I == null) self.I = nil;
if (v == null) v = nil;if (x == null) x = nil;
      return self.mem['$[]='](self.I['$+'](x), v)}, TMP_12._s = self, TMP_12), $a).call($d)}else if ((85)['$===']($case)) {($a = ($e = (f00['$+'](1))).$times, $a._p = (TMP_13 = function(x){var self = TMP_13._s || this;
        if (self.mem == null) self.mem = nil;
        if (self.I == null) self.I = nil;
        if (self.v == null) self.v = nil;
if (x == null) x = nil;
      return self.mem['$[]='](x['$+'](self.I), self.v['$[]'](x))}, TMP_13._s = self, TMP_13), $a).call($e)}else if ((101)['$===']($case)) {($a = ($f = (f00['$+'](1))).$times, $a._p = (TMP_14 = function(x){var self = TMP_14._s || this;
        if (self.v == null) self.v = nil;
        if (self.mem == null) self.mem = nil;
        if (self.I == null) self.I = nil;
if (x == null) x = nil;
      return self.v['$[]='](x, self.mem['$[]'](x['$+'](self.I)).$to_i())}, TMP_14._s = self, TMP_14), $a).call($f)}};
      return true;
    }, nil);
  })(self, null);
})(Opal);
