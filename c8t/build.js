...
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;
  $opal.add_stubs(['$output', '$parse', '$new', '$run_multiple', '$unparse', '$join', '$map', '$sprintf', '$to_i', '$scan', '$split', '$each', '$gsub', '$ord', '$reverse', '$decode', '$parameter', '$[]', '$+', '$encode', '$to_json', '$value', '$minify', '$value=', '$send!', '$errback', '$p', '$callback', '$data', '$json', '$results', '$body']);
  ;
  ;
  ;
  ;
  return (function($base, $super) {
    ...
    return (def.$list = function() {
      var $a, $b, TMP_7, $c, $d, TMP_8, $e, self = this, opts = nil;
      opts = $hash2(["payload"], {"payload": "format=json&q="['$+'](self.$encode("select * from json where url=\"https://bitly.com/u/c8tc8t.json?callback=lol\""))});
      return ($a = ($b = ($c = ($d = (($e = $scope.HTTP) == null ? $opal.cm('HTTP') : $e)).$new, $c._p = (TMP_8 = function(response){var self = TMP_8._s || this, $a;if (response == null) response = nil;
      self.$p(response);
        return self.$p((($a = $scope.JSON) == null ? $opal.cm('JSON') : $a).$parse(response.$body()).$results().$json().$data());}, TMP_8._s = self, TMP_8), $c).call($d, "http://query.yahooapis.com/v1/public/yql", "POST", opts)).$errback, $a._p = (TMP_7 = function(a, b, c){var self = TMP_7._s || this;if (a == null) a = nil;if (b == null) b = nil;if (c == null) c = nil;
      return self.$p(a, b, c)}, TMP_7._s = self, TMP_7), $a).call($b)['$send!']();
    }, nil);
  })(self, null);
})(Opal);
