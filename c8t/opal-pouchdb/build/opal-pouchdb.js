...
/* Generated by Opal 0.5.5 */
(function($opal) {
  var $a, $b, TMP_5, $c, TMP_6, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2, db = nil;
  $opal.add_stubs(['$join', '$map', '$nil?', '$c', '$each', '$instance_eval', '$define_method', '$metaclass', '$create_methods', '$p', '$new', '$put', '$get']);
  ;
  (function($base, $super) {
    function $PouchDB(){};
    var self = $PouchDB = $klass($base, $super, 'PouchDB', $PouchDB);

    var def = $PouchDB._proto, $scope = $PouchDB._scope;
    def.$c = function(args, prefix) {
      var $a, $b, TMP_1, self = this, params = nil;
      if (prefix == null) {
        prefix = nil
      }
      params = "(" + (($a = ($b = args).$map, $a._p = (TMP_1 = function(x){var self = TMP_1._s || this;if (x == null) x = nil;
      return "\"" + (x) + "\""}, TMP_1._s = self, TMP_1), $a).call($b).$join(", ")) + ")";
      if (($a = prefix['$nil?']()) !== false && $a !== nil) {
        return self.pouch.params;
        } else {
        return prefixparams;
      };
    };
    ...
    def.$initialize = function(args) {
      var self = this;
      args = $slice.call(arguments, 0);
      return self.pouch = self.$c(args, "new PouchDB");
    };

    $opal.defs(self, '$metaclass', function() {
      var self = this;
    ...
    $opal.defs(self, '$create_methods', function(arr) {
      var $a, $b, TMP_2, self = this;
      arr = $slice.call(arguments, 0);
      return ($a = ($b = arr).$each, $a._p = (TMP_2 = function(a){var self = TMP_2._s || this, $a, $b, TMP_3;if (a == null) a = nil;
      return ($a = ($b = self.$metaclass()).$instance_eval, $a._p = (TMP_3 = function(){var self = TMP_3._s || this, $a, $b, TMP_4;
        return ($a = ($b = self).$define_method, $a._p = (TMP_4 = function(args){var self = TMP_4._s || this;args = $slice.call(arguments, 0);
          return self.$c(args)}, TMP_4._s = self, TMP_4), $a).call($b, a)}, TMP_3._s = self, TMP_3), $a).call($b)}, TMP_2._s = self, TMP_2), $a).call($b);
    });

    return self.$create_methods("destroy", "put", "get", "post", "remove", "bulkDocs", "allDocs", "changes");
  })(self, null);
  self.$p("test");
  db = (($a = $scope.PouchDB) == null ? $opal.cm('PouchDB') : $a).$new("blah");
  self.$p(db);
  ($a = ($b = db).$put, $a._p = (TMP_5 = function(err, resp){var self = TMP_5._s || this;if (err == null) err = nil;if (resp == null) resp = nil;
  return self.$p(err, resp)}, TMP_5._s = self, TMP_5), $a).call($b, $hash2(["_id", "title"], {"_id": "mydoc", "title": "Heroes"}));
  return ($a = ($c = db).$get, $a._p = (TMP_6 = function(err, resp){var self = TMP_6._s || this;if (err == null) err = nil;if (resp == null) resp = nil;
  return self.$p(err, resp)}, TMP_6._s = self, TMP_6), $a).call($c, "Heroes");
})(Opal);

//@ sourceMappingURL=/__opal_source_maps__/opal-pouchdb.js.map
;
